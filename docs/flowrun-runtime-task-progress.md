...
| FR-461 | 过程解释文本会话引用 | DONE | 已持久化的 `ThinkAction` 与 Tool Action 可见 `thought` 可作为 FlowWeave 会话引用／协作锚点；工具参数、命令、Observation 与工具输出继续禁止作为隐式引用上下文。 |
