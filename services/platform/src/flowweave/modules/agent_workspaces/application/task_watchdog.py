...
OpenHands owns Task/child-Agent execution, including model request timeouts and
retries. FlowWeave only reads its formal events; it must not manufacture
timeouts, interrupts, Runtime replacement, or parent Conversation continuation
