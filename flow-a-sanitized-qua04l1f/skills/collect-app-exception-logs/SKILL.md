...
collect mode performs only Phase 1 and writes collection artifacts. investigate mode processes closed fingerprints, completes Phase 2, and publishes/read-backs evidence. Neither mode reads source code.
