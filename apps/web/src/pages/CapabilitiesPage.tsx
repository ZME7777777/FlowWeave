...
import { Braces, CheckSquare, FileArchive, Layers3, LockKeyhole, Pencil, PlugZap, ShieldCheck, Trash2, Upload } from 'lucide-react';
...
const CAPABILITY_MODULES: CapabilityAssetType[] = ['SKILL', 'PLUGIN', 'MCP', 'HOOK', 'AGENT_DEFINITION'];
