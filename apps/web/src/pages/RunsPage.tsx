...
function RunResourceCell({ run }: { run: FlowRunSummary }) {
  ...
  if (!active) return <span><b>暂无可用容器</b><small>运行环境就绪后将显示当前绑定容器。</small></span>;
