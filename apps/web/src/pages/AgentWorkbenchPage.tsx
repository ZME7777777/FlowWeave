...
import { Bot, ChevronRight, CircleDot, LoaderCircle, Minimize2, PanelRightOpen, Pencil, Play, Plus, Send, Settings2, Square, Terminal, Trash2, X } from 'lucide-react';
...
import type { AgentAttachment, AgentConversation, OpenHandsConversationEvent } from '../types';
...
export function AgentWorkbenchPage({ onNavigate, onOpenModels }: Props) {
  ...
  const visibleError = (create.error || rename.error || remove.error || upload.error || condense.error || fork.error || interrupt.error || resume.error || rewrite.error || eventsQuery.error)
