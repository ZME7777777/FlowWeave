...
export function WorkbenchPage() {
  ...
  const nodeRunCanDelete = (record: NodeRun) => (
    ...
    || (record.state === 'ACTIVE'
      && (record.attempts.at(-1)?.state === 'WAITING_INPUT' || record.attempts.at(-1)?.state === 'WAITING_START_CONFIRMATION')
