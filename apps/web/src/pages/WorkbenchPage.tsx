...
export function WorkbenchPage() {
  ...
  return <>
    <header className="flow-run-workbench-header"><h1 title={run.name}>{run.name}</h1><span data-testid="flow-run-state" className={`run-state ${run.state.toLowerCase()}`}>{FLOW_STATE_LABELS[run.state] ?? run.state}</span></header>
