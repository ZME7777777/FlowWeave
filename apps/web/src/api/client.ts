...
export const api = {
  ...
  retryGateWithProvider: (attemptId: string, evaluationId: string, version: number, agent_preset: import('../types').GateAgentPreset) => request<NodeAttempt>(`/node-attempts/${attemptId}/gate-evaluations/retry-with-provider`, json('POST', { evaluation_id: evaluationId, expected_state_version: version, agent_preset }, true)),
