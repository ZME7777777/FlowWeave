...
export interface AgentSessionRuntime {
  ...
  /** Completed node Attempts may create or fork detached conversations without reopening execution. */
...
export interface AgentConversationAnnotation {
  id: string;
...
export interface AgentConversationContext {
  ...
  view_event_count?: number | null;
  provider_id?: string | null;
  model_name?: string | null; reasoning_effort?: string | null;
  condenser_max_size?: number | null; condenser_max_tokens?: number | null;
