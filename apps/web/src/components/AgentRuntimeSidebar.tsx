...
import { CircleDot, ExternalLink, Info, Maximize2, Minimize2, PanelRightClose, PanelRightOpen, Radar, ShieldCheck, Terminal, X } from 'lucide-react';
...
export function AgentRuntimeSidebar({ conversation, children, governance, collapsed, onCollapsedChange }: Props) {
