...
import { ConversationLiveOverlays, ConversationSurface, type ConversationReference } from '../ConversationSurface';
  ...
  return <main className="agent-workbench-page">
    ...
    <section className="agent-workbench-main">
      ...
      {(selected || conversationDraft) && runtimeWritable && runtime?.state !== 'RECOVERING' && <>
        <ConversationLiveOverlays events={displayedEvents} isGenerating={isGenerating} onReviewChanges={openChangesReview} workspaceRoot={activeWorkspaceRoot}/>
