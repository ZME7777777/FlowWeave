...
DEFAULT_ES_USER = os.environ.get("ES_QUERY_USER", "")
DEFAULT_ES_PASS = os.environ.get("ES_QUERY_PASSWORD", "")
...
ENV_PRESETS = {
    "hk": {
        ...
        "user": os.environ.get("ES_QUERY_USER", ""),
        "password": os.environ.get("ES_QUERY_PASSWORD", ""),
