...
collect mode performs only Phase 1 and writes collection artifacts. investigate mode processes closed fingerprints, completes Phase 2, then publishes and reads back evidence. Neither mode reads source code.
